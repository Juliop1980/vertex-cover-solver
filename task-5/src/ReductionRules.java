...
public class ReductionRules {
    ...
    public ReductionRules(boolean oneDegreeRule, boolean twoDegreeRule, boolean dominationRule, boolean independentRule,boolean twinRulePre){
